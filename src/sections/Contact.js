...
import { ArrowBigUpDash, Github, Instagram, Linkedin, Send, Twitter } from "lucide-react";
            ...
            <div className="w-full">
                ...
                <div className="flex flex-col justify-center items-center -mt-5">
                    <div className="w-4/5 py-10 items-center sm:justify-center flex flex-col">
                        <div className="-mt-6 grid grid-cols-2 sm:grid-cols-3 grid-rows-2 gap-7 w-4/5 justify-center items-center">
                        ...
                        <div className="w-4/5 mt-20 p-1 flex items-center">
                            <h1 className="font-brandonMedium text-md text-left">Let's connect!</h1>
