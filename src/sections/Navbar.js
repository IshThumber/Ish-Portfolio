...
const NavbarSimple = () => {
  return (
    <Navbar className="w-3/4 px-4 py-3 m-2 mx-auto border-2 shadow-none md:py-2 bg-wild-sand-100 font-gtReg rounded-xl md:rounded-2xl backdrop-filter backdrop-blur-md bg-opacity-60 border-desert-storm-100 dark:border-wild-sand-700">
