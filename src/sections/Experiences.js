          ...
          <div className="flex flex-col w-full px-9 md:w-4/5 mb-6">
            {experience.map(key => {
              return (
                <div
                  key={key.id}
                  className="bigShadowButton border border-gray-800 bg-pink-50 p-5 pl mt-4 text-md justify-start w-full md:w-3/4 items-center rounded-3xl font-ikaros font-thin"
                >
                  <>
