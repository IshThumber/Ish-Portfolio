      ...
      <div className="w-full">
        ...
        <div className="flex flex-col justify-center items-center -mt-5">
          <div className="flex flex-col w-full px-9 md:w-4/5 mb-6">
            {education.map((key) => {
              return (
                <div className="bigShadowButton border border-gray-800 bg-amber-50 p-4 mt-4 text-md justify-start w-full md:w-3/4 items-center rounded-md font-ikaros font-thin">
