    ...
    <div className="min-h-screen transition-all duration-500">
      ...
      <main className="relative w-[97%] md:w-5/6 p-2 lg:p-6 font-gtReg text-wild-sand-200 mx-auto">
        <div className="flex flex-col items-center justify-center gap-8 text-center">
          <h1 className="font-black tracking-tight font-urbanist text-[4rem] lg:text-9xl bg-gradient-to-r from-purple-300 to-genoa-300 inline-block text-transparent bg-clip-text">
            404
          </h1>
