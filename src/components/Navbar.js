	...
	return (
		<li className="relative">
			<NavLink
				to={to}
				onClick={onClick}
				className="relative block px-5 py-2 text-md text-gray-300 transition-colors duration-300 rounded-2xl font-gtReg hover:text-white"
		...
		<>
			<header className="fixed top-0 left-0 z-50 w-full p-4">
				<nav
					...
					className={`relative w-full max-w-5xl px-4 py-3 mx-auto border-2 border-blue-gray-700/50 font-gtReg rounded-2xl bg-blue-gray-800/40 backdrop-blur-xl shadow-l transition-shadow duration-300 ${isScrolled ? "shadow-purple-500/10" : ""
						}`}
				...
				>
					<div className="flex items-center justify-between text-wild-sand-300">
						...
						<div className="hidden lg:block">
							<a
								href="/contact"
								className="px-5 py-3 rounded-xl bg-purple-400 hover:bg-gradient-to-r from-purple-400 to-purple-700 hover:text-wild-sand-100 text-wild-sand-100 font-bold transition-all duration-300"
								aria-label="Contact"
							>
								Get in Touch
							</a>
